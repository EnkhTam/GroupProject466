...
//		mysqli_stmt_close($prep);
		/*mysqli_query($conn, "INSERT INTO workoutlogs (user_id, workout_name, workout_date, calories_burned, hours, minutes)
					VALUES ('$use','$WO_name','$WO_date','$WO_cals','$WO_hours','$WO_minutes')");*/
		$sql = "INSERT INTO workoutlogs (user_id, workout_name, workout_date, calories_burned, hours, minutes)
					VALUES (?, ?, ?, ?, ?, ?)";
			$pdo->prepare($sql)->execute([$use, $WO_name, $WO_date, $WO_cals, $WO_hours, $WO_minutes]);
