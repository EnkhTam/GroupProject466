...
mysqli_query($conn, "INSERT INTO user (user_id, birth_date, first_name, last_name, user_name, pass_word, email, wset_id, mset_id)
			VALUES ('1', '2000-01-01', 'test0', 'test0', 'test0','test0','test0', 28, 33)");
...
mysqli_query($conn, "INSERT INTO settings(uset_id, user_id, wset_id, mset_id)
			VALUES ('1','1','28','33')");*/
...
//copy-paste in to delete everything
/*
truncate pw_history; drop table pw_history; truncate sq_user; drop table sq_user; truncate security_questions; drop table security_questions; truncate weightlogs; drop table weightlogs; truncate workoutlogs; drop table workoutlogs; truncate foodlogs; drop table foodlogs; truncate food; drop table food; truncate user; drop table user;
*/
?>
</head>
</html>
