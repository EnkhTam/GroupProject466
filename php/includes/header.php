...
<div class = "top">
<br><br><br><br><br>
		<div class = "welcome"><h2> Welcome, <?php echo $user?></h2></div>
		<center>
	  ...
	  <div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="myNavbar">
		  ...
		  <ul class="nav navbar-nav">
			<li><a href="../views/userinfo.php">Your Info</a></li>
			<li><a href="../views/food.php">Food Log</a></li>
			<li><a href="../views/workouts.php">Workout Log</a></li>
